...
import { ArrowLeft, Plane, MapPin, Clock, Users, Award, Globe, Calendar, Wrench, Star } from 'lucide-react';
...
export default function FlightDetail() {
  ...
  useEffect(() => {
    aeroApi.Flight.getById(id).then(setFlight).finally(() => setLoading(false));
  }, [id]);
